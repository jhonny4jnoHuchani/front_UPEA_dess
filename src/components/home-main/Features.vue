    ...
    <div class="container">
      <div class="features-grid-wrap">
        <div class="features-box features-style-2 edublink-svg-animate">
          ...
          <div class="content">
            <h5 class="title"><span>+35</span>Carreras</h5>
          </div>
        </div>
        <div class="features-box features-style-2 edublink-svg-animate">
          <div class="icon">
          ...
          <div class="content">
            <h5 class="title"><span>+1.500</span>Docentes</h5>
          </div>
        </div>
        <div class="features-box features-style-2 edublink-svg-animate">
          ...
          <div class="content">
            <h5 class="title"><span>+30.000</span>Titulados</h5>
          </div>
        </div>
        <div class="features-box features-style-2 edublink-svg-animate">
          <div class="icon">
          ...
          <div class="content">
            <h5 class="title"><span>+80.000</span>Estudiantes</h5>
          </div>
        </div>
      </div>
    </div>
