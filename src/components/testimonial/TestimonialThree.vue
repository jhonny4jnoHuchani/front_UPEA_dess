<template>
    <div class="testimonial-area-2 section-gap-large">
        <div class="container edublink-animated-shape">
            ...
            <swiper
                class="testimonial-activation swiper"
                ...
                <div class="swiper-slide">
                    <div class="testimonial-slide">
                        <div class="content">
                            ...
                            <p>
                                Lorem ipsum dolor amet consectur elit adicing
                                elit sed do umod tempor ux incididunt enim ad
                                minim veniam quis nosrud citation laboris
                                nisiste aliquip comodo perspiatix.
                            </p>
        ...
        <ul class="shape-group">
            <li class="shape-3">
                <img
                    class="d-block-shape-light"
                    data-depth="2"
                    src="/images/others/map-shape-3.png"
                    alt="Shape"
                />
                <img
                    class="d-none-shape-dark"
                    data-depth="2"
                    src="/images/others/dark-map-2-shape-3.png"
                    alt="Shape"
                />
            </li>
        </ul>
