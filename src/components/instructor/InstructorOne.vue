      ...
      <div class="thumbnail-wrap">
        <div class="thumbnail">
          <router-link :to="`/AutoridadDetalle/${encrypted(autoridad.id_autoridad)}`">
            <img :src="foto(autoridad.foto_autoridad)" alt="instructor" />
          </router-link>
        </div>
        <ul class="team-share-info">
          ...
          <li>
            <a aria-label="Facebook" target="_blank" :href="autoridad.facebook_autoridad">
              <i class="icon-facebook"></i>
            </a>
          </li>
          <li>
            <a aria-label="Twitter" target="_blank" :href="autoridad.twiter_autoridad">
              <i class="icon-twitter"></i>
            </a>
          </li>
          <li>
            <a aria-label="Telefono" target="_blank" :href="autoridad.celular_autoridad">
...
const foto = (foto) => {
  if (!foto) return '/default-image.jpg';
   return `${api}${foto}`;
};
