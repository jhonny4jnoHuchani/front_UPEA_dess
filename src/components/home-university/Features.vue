    ...
    <div class="features-area-3">
        <div class="container">
            <div class="features-grid-wrap">
                <div
                    class="features-box features-style-3 color-primary-style edublink-svg-animate"
                >
                    <div class="icon">
                        <svg
                            class="svgInject"
                    ...
                    <div class="content">
                        ...
                        <p>
                            La Universidad Pública de El Alto brinda igualdad de
                            oportunidades.
                        </p>
                    </div>
                </div>
                ...
                <div
                    class="features-box features-style-3 color-secondary-style edublink-svg-animate"
                >
                    <div class="icon">
                        <svg
                            class="svgInject home-3-skilled-lecturer-svg"
                            version="1.1"
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="content">
                        <h4 class="title">
                            Enfoque en la investigación y la excelencia
                            académica
                        </h4>
                        <p>
                            La Universidad Pública de El Alto enfatiza la
                            investigación y calidad académica.
                        </p>
                    </div>
                </div>

                <div
                    class="features-box features-style-3 color-extra02-style edublink-svg-animate"
                >
                    <div class="icon">
                        <svg
                            class="svgInject home-3-book-library-svg"
                            version="1.1"
                            xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink"
                            x="0px"
                        ...
                        >
                            <g>
                                ...
                                <path
                                    class="bookpath"
                                    d="M22.52,4.88v14.36c0,0.14,0.17,0.21,0.27,0.11l3.54-3.54c0.06-0.06,0.16-0.06,0.22,0l3.8,3.8
                    ...
                    <div class="content">
                        <h4 class="title">
                            Vínculo con la comunidad y responsabilidad social
                        </h4>
                        <p>
                            La Universidad Pública de El Alto se compromete con
                            la comunidad y responsabilidad social.
                        </p>
                    </div>
                </div>
            </div>
...
<style>
.home-3-skilled-lecturer-svg .st0 {
    fill: none;
    stroke: var(--color-secondary);
    stroke-width: 2;
    stroke-miterlimit: 10;
}
.home-3-skilled-lecturer-svg .st1 {
    fill: none;
    stroke: var(--color-secondary);
    stroke-width: 2;
    stroke-linecap: round;
...
.home-3-skilled-lecturer-svg .st2 {
    fill: none;
    stroke: var(--color-secondary);
    stroke-width: 2;
    stroke-linecap: round;
...
.home-3-book-library-svg .bookpath {
    fill: none;
    stroke: var(--color-extra02);
    stroke-width: 2;
    stroke-miterlimit: 10;
}
</style>
