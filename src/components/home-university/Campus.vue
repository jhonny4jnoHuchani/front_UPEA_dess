            ...
            <div class="row g-5">
                ...
                >
                    <div class="campus-image-gallery">
                        <div class="campus-thumbnail">
                            <div class="thumbnail">
                                <img
                                    src="/images/others/campus-01.jpg"
                                    alt="Campus"
                                />
                            </div>
                        </div>
                ...
                >
                    <div class="campus-content">
                            ...
                            <div class="features-list">
                                <div class="features-box color-secondary-style">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Nostrud exer ciation laboris nis
                                            aliqup comodo perspiatix omnis iste
                                            natus.
                                        </p>
                                    </div>
                                </div>
                                <div class="features-box color-primary-style">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            ...
                                            voluptatem accusan tium doloreque
                                            laudantum.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <ul class="shape-group">
                            <MouseMove addClassName="shape-4" dataDepth=".8" />
                            <MouseMove addClassName="shape-5" dataDepth="2" />
                            <MouseMove
