(function (t) {
            ...
            return function (t) {
                if (
                    (z ||
                        ...
                        (_ = g("boxSizing")) &&
                            (((c = document.createElement("div")).style.width =
                                "200px"),
                    ...
                    for (
                        ...
                        var s = b[n],
                            a = (function (t, e) {
                                if (L.getComputedStyle || -1 === e.indexOf("%"))
                                    return e;
                                var i = t.style,
                                    o = i.left,
                                    n = t.runtimeStyle,
    ...
    (function (i, o) {
        ...
        (f.isArray = function (t) {
            ...
            (f.filterFindElements = function (t, e) {
                for (
                    var i = [], o = 0, n = (t = f.makeArray(t)).length;
                    o < n;
                    o++
                ) {
                    var r = t[o];
    ...
    (function (n, r) {
        ...
        (n.prototype._transitionTo = function (t, e) {
            ...
            (n.prototype.moveTo = h
                ? n.prototype._transitionTo
                : n.prototype.goTo),
    ...
    (function (r, s) {
        ...
        return (
            ...
            (s.prototype.getItems = function (t) {
                for (
                    var e = [], i = 0, o = (t = r.makeArray(t)).length;
                    i < o;
                    i++
                ) {
                    var n = t[i],
            ...
            (s.create = function (t, e) {
                ...
                return (
                    ...
                    ((i.prototype.constructor = i).defaults = r.extend(
                        {},
                        s.defaults
                    )),
            ...
            (t.prototype._manageStamp = function (t) {
                ...
                for (
                    var n = Math.min(this.cols - 1, n),
                        r =
                            (this.options.isOriginTop ? i.top : i.bottom) +
                            e.outerHeight,
                        s = o;
                    s <= n;
                    s++
    ...
    (function (s, a) {
            ...
            (h.prototype._bindArrangeComplete = function () {
                function t() {
                    e &&
                        i &&
                        o &&
                        n.emitEvent("arrangeComplete", [n.filteredItems]);
                }
                var e,
                    i,
                    o,
        ...
        (h.sortDataParsers = {
            ...
            (h.prototype._resetLayout = function () {
                o.prototype._resetLayout.call(this),
